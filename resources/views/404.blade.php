...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			<img src="{{URL::asset('img/404.png')}}" class="error-page" style="height: 800px; width: 1000px" alt="error">
			<h2>Oopps. The page you were looking for doesn't exist.</h2>
			<h6>You may have mistyped the address or the page may have moved.</h6><a class="btn btn-outline-danger" href="{{ url('/' . $page='/blog') }}">Back to Home</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
