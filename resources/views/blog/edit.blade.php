                ...
                <form action="/blog/{{ $posts->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="background-color: #b9b9b2; padding: 10px" class="container">
                        ...
                        <div style="margin: 30px" class="input-group-prepend">
                            <input type="text" value="{{ $posts->title }}" class="form-control" id="usr" name="title"
                                placeholder="Title">
                        </div>

                        <div style="margin: 30px" class="mb-3">
                            <textarea class="form-control" placeholder="Content"name="content" id="exampleFormControlTextarea1" rows="3">{{ $posts->content }}</textarea>
                        </div>
